...
const SelectDevice = (props) => {
    ...
    height:verticalScale(450)}}>
        ...
        <Text style={{color:"black",fontSize:Scale(25),fontFamily:'Montserrat-Medium'}}>
            Add Device
        </Text>
        </View>
        ...
        <Text style={{fontSize:Scale(18),color:appTheme('font'),fontFamily:'Inter'}}>Switch Board</Text>
        ...
        <Text style={{fontSize:Scale(18),color:appTheme('font'),fontFamily:'Inter'}}>Monitor Sensor</Text>
        <Image source={ICONS.arrow} style={{height:verticalScale(18), width:Scale(15)}}  tintColor="grey"/>

        </View>

        <View style={{height:verticalScale(55),width:'85%',borderBottomColor:appTheme('inputBorder'),borderBottomWidth:1,justifyContent:"space-between",display:"flex",flexDirection:"row",paddingTop:14}}>
        <Text style={{fontSize:Scale(18), color:appTheme('font'),fontFamily:'Inter'}}>IR Blaster</Text>
        <Image source={ICONS.arrow} style={{height:verticalScale(18), width:Scale(15)}}  tintColor="grey"/>

        </View>

        <View style={{height:verticalScale(55),width:'85%',borderBottomColor:appTheme('inputBorder'),borderBottomWidth:1,justifyContent:"space-between",display:"flex",flexDirection:"row",paddingTop:14}}>
        <Text style={{fontSize:Scale(18),color:appTheme('font'),fontFamily:'Inter'}}>Camera</Text>
        <Image source={ICONS.arrow} style={{height:verticalScale(18), width:Scale(15)}}  tintColor="grey"/>
